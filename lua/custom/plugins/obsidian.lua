...
return {
  ...
  opts = {
    ...
    mappings = {
      ...
      ['<leader>ob'] = {
        action = function()
          return require('obsidian').util.open_app_foreground()
        end,
        opts = { noremap = true, buffer = true, desc = '[Ob]sidian' },
      },
      ...
      -- Open the daily note for yesterday.
      ['<C-A-y>'] = {
      ...
      ['<leader>tc0'] = {
        ...
        { noremap = true, silent = true, desc = 'git [T]oggle [C]onceallevel [0]' },
      },
      ['<leader>tc1'] = {
